...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("5 houses in my neighborhood"), False)
        self.assertEqual(pythonBasics3.starts_with_non_number("I woke up today"), True)
        self.assertEqual(pythonBasics3.starts_with_non_number("6 is my favorite number"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        # Please add three more test cases following the order above
        self.assertEqual(pythonBasics3.multiple_words("That's cool"), True)
        self.assertEqual(pythonBasics3.multiple_words("That's awesome"), True)
        self.assertEqual(pythonBasics3.multiple_words("Yes"), False)
